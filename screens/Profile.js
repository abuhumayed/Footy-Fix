...
import { StyleSheet, Text, View, SafeAreaView, Image, ScrollView,TouchableOpacity,useWindowDimensions } from "react-native";
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{ flexDirection: 'row'}}>
                    <View style={styles.profileImage}>
                        <Image source={require("../assets/PlayerProfilePlaceHolder.jpg")} style={styles.image} resizeMode="center"></Image>
                    </View>

                <View style={styles.infoContainer}>
                    <Text style={[styles.text, { fontWeight: "200", fontSize: 20,fontWeight:'bold'  }]}>Julian </Text>
                    <Text style={[styles.text, { fontWeight: "200", fontSize: 20,fontWeight:'bold'  }]}>Gray </Text>
                    <Text style={[styles.text, { color: "#AEB5BC", fontSize: 14, backgroundColor:'#90ee90',fontWeight:'bold',marginTop:10,color:'black' }]}>Defender</Text>
                </View>
                </View>
