...
export default () => {
  ...
  return (
    ...
    >
      ...
      <Image source={require("../src/icons/Logo.png")} />
      <Image source={require("../src/icons/FOOTYFIXText.png")} />
        ...
        onPress={() => {
          ...
          if (!isValid.password) {
            passwordField.errorMessage =
              "Password must contain atleast; 8 characters, 1 Uppercase,1 Lowercase and 1 Number";
      ...
      >
        <Text style={{ fontWeight: "normal", textDecorationLine: "underline" }}>
          Forgot Password?
        </Text>
      </TouchableOpacity>
